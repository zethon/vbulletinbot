...
namespace VBulletinBot.VBotService {
    ...
    [System.Xml.Serialization.SoapIncludeAttribute(typeof(PostNotification))]
    public partial class VBotService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetPostNotificationsOperationCompleted;
        ...
        /// <remarks/>
        public event GetPostNotificationsCompletedEventHandler GetPostNotificationsCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("http://www.anothermessageboard.com/vbulletinbot.php/GetPostNotifications", RequestNamespace="http://www.anothermessageboard.com", ResponseNamespace="http://www.anothermessageboard.com")]
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public PostNotificationsResult GetPostNotifications(bool DoDelete) {
            object[] results = this.Invoke("GetPostNotifications", new object[] {
                        DoDelete});
            return ((PostNotificationsResult)(results[0]));
        }
        
        /// <remarks/>
        public void GetPostNotificationsAsync(bool DoDelete) {
            this.GetPostNotificationsAsync(DoDelete, null);
        }
        
        /// <remarks/>
        public void GetPostNotificationsAsync(bool DoDelete, object userState) {
            if ((this.GetPostNotificationsOperationCompleted == null)) {
                this.GetPostNotificationsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetPostNotificationsOperationCompleted);
            }
            this.InvokeAsync("GetPostNotifications", new object[] {
                        DoDelete}, this.GetPostNotificationsOperationCompleted, userState);
        }
        
        private void OnGetPostNotificationsOperationCompleted(object arg) {
            if ((this.GetPostNotificationsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetPostNotificationsCompleted(this, new GetPostNotificationsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.SoapTypeAttribute(Namespace="urn:VBotService")]
    public partial class PostNotificationsResult {
        
        private RequestResult resultField;
        
        private PostNotification[] postNotificationListField;
        ...
        /// <remarks/>
        public PostNotification[] PostNotificationList {
            get {
                return this.postNotificationListField;
            }
            set {
                this.postNotificationListField = value;
            }
        }
    }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    public delegate void GetPostNotificationsCompletedEventHandler(object sender, GetPostNotificationsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetPostNotificationsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetPostNotificationsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public PostNotificationsResult Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((PostNotificationsResult)(this.results[0]));
            }
        }
    }
}
